	...
	<body class="home home-4">
		<div id="all">
													...
													<li class="dropdown-submenu">
														...
														<div class="dropdown-menu level2">
															<ul>
																...
																<li><a href="compte.php" title="My Account">My Account</a></li>
			...
			<div id="content" class="site-content">
				...
				<div id="breadcrumb">
					<div class="container">
						<h2 class="title">Liste Commentaires </h2>
						
						<ul class="breadcrumb">
							<li><a href="#" title="Home">Home</a></li>
							<li><span>Liste Commentaires</span></li>
						</ul>
					</div>
				</div>
					...
					<div class="container page-cart">
							...
							<table class="cart-summary table table-bordered">
								<thead>
									...
									<tr>
										...
										<th class="width-80 text-center">Commentaire</th>
										<th class="width-20 text-center">Nom Client</th>
										<th class="width-20 text-center">Prénom Clinet</th>
										<th class="width-100 text-center">Accept</th>
								...
								<?php  include 'updateComments.php'; }  ?>
						...
						<div class="checkout-btn right">
							...
							<div class="modal-dialog" role="document">
								...
								<form enctype="multipart/form-data" action ="php/controller/addProduit.php" method="POST" >
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<select name="cat" class="form-control">
											<option value="vegtables">vegtables</otpion>
											<option value="fruits" >Fruits</otpion>
											<option value="juice"> juice</otpion>
										</select>
