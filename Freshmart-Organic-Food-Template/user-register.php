...
<div class="block-cart dropdown" >
								...
								<div class="my-account dropdown toggle-icon">
									...
									<div class="item">
										...
										<div class="item">
											<a href="wishlists.php" title="My Wishlists"><i class="fa fa-heart"></i>My Wishlists</a>
										</div>		
										<?php
				...
				<div class="container">
					<div class="register-page">
						<div class="register-form form">
							...
							<form action="php/controller/register.php" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label>First Name</label>
									<input type="text" value="" required name="first_name">
								</div>
								
								<div class="form-group">
									<label>Last Name</label>
									<input type="text" value="" required name="last_name">
								</div>
								...
								<div class="form-group">
									...
									<input type="text" value="" required name="tel">
								</div>
