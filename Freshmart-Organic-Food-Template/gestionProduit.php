								...
								<?php
									...
									<tr>
										<td class="product-remove">
											<a title="Remove this item" class="remove" href="php/controller/suppProduit.php?id=<?php echo $value[0];?>">
										...
										<td>
											<a href="product-detail-left-sidebar.php?id=<?php echo $value[0] ?>">
												...
												?>
												<img width="80" alt="Product Image" class="img-responsive" src="img/product1/<?php echo $pieces[0]?>">
												<?php
												unset($pieces);
												?>
											</a>
