...
if(isset($_SESSION['email']) && isset($_SESSION['motpass'])){
	//echo $_SESSION['email'] ."/".$_SESSION['motpass'];
	//die();
$prod=new Produit();
$client=new Client();
													...
													<li class="dropdown-submenu">
														...
														<div class="dropdown-menu level2">
															<ul>
																...
																<li><a href="#" title="My Account">Account</a></li>
				...
				<div class="container">
					<div class="account-page">
						<div class="register-form form">
							...
							<form action="php/controller/updateCompte.php" method="post" enctype="multipart/form-data">
                                <?php
                                ...
                                <div class="form-group">
                                <label>Code</label>
									<input type="text" readonly="readonly" class="col-sm-2" value="<?php echo $value[6]?>" required name="id">
								</div>
								<div class="form-group">
									<label>First Name</label>
									<input type="text" value=<?php echo $value[1]?> required name="first_name">
								</div>
								
								<div class="form-group">
									<label>Last Name</label>
									<input type="text" value=<?php echo $value[2]?> required name="last_name">
								</div>
								
								<div class="form-group">
									<label>Email</label>
									<input type="email" value=<?php echo $value[3]?> required name="email">
								</div>
								
								<div class="form-group">
									<label>Password</label>
									<input type="password" value=<?php echo $value[4]?> required name="password">
								</div>
								<div class="form-group">
									<label>telephone</label>
									<input type="text" value=<?php echo $value[5]?> required name="tel">
								</div>
