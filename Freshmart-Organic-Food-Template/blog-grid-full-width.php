...
<?php
	...
	@$page=$_GET["page"];
	$nb_elment_parpage=3;
	$nbr_depage=ceil($tcount/$nb_elment_parpage);
	// print_r($nbr_depage);
	// print_r($page);
	$debut=($page-1)*$nbr_depage;
	//  print_r($debut);
	
	$row2=$prod->afficherProduitByLimit($debut,$nb_elment_parpage);
										...
										<li class="dropdown">
											...
											<div class="dropdown-menu">
												<ul class="has-sub">
													...
													<li><a href="blog-grid-full-width.php" title="Blog Grid - Full Width">Blog Grid - Full Width</a></li>
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<div class="post-item">
										<div class="post-image">
											<a href="#">
												<?php
													$img=explode(",",$value[4]);
												?>
												<img class="img-responsive" src="img/product1/<?php echo $img[0];?>" alt="Blog Image">
										...
										<a class="post-title" href="blog-detail.html"><?php echo $value[6];?></a>
										<div class="post-info">
											<span class="comment item"><i class="zmdi zmdi-comments"></i>Prix : <?php echo $value[1];?></span>
											<span class="date item"><i class="zmdi zmdi-calendar-note"></i>Solde: <?php echo $value[2];?></span>
										</div>
						...
						<div class="pagination-bar">
							<div class="pagination">
								<ul class="page-list">
									...
									?>
									<li><a href="?page=<?php echo $i?>" class="current"><?php echo $i  ?></a>&nbsp</li>
